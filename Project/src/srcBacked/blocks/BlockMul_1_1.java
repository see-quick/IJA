...
/**
 * BlockMul_1_1.java - Subclass of a class Block, defines one kind of a block which can be used in calculations
 */
public class BlockMul_1_1 extends Block {

    static private final String[][] portsIn = new String[][]{{"T1", "T2"}};
     ...
     */
    public BlockMul_1_1(Linker linker) throws MyException {
    ...
    protected void calculateHelper(SchemeManager sm) throws MyException, InterruptedException {
        ...
        Double temp2 = getPortInValue(0, "T2");
