...
/**
 * BlockSub_1_1.java - Subclass of a class Block, defines one kind of a block which can be used in calculations
 */
public class BlockSub_1_1 extends Block {
     ...
     */
    public BlockSub_1_1(Linker linker) throws MyException {
