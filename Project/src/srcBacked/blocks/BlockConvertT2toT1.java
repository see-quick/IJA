...
/**
 * BlockConvertT2toT1.java - Subclass of a class Block, defines one kind of a block which can be used in calculations
 */
public class BlockConvertT2toT1 extends Block {

    static private final String[][] portsIn = new String[][]{{"T2"}};
     ...
     */
    public BlockConvertT2toT1(Linker linker) throws MyException {
    ...
    public void checkInputs() throws MyException {
        ...
        if(!(getLinker().isThisInputPortConnected(getPortInByIndex(0))) && getPortInValue(0, "T2") == null){
    ...
    protected void calculateHelper(SchemeManager sm) throws MyException, InterruptedException {
        ...
        Double temp1 = getPortInValue(0, "T2");
