...
/**
 * BlockAdd_1_1.java - Subclass of a class Block, defines one kind of a block which can be used in calculations
 */
public class BlockAdd_1_1 extends Block {
     ...
     */
    public BlockAdd_1_1(Linker linker) throws MyException {
